...
import GoogleAuth from '../components/GoogleAuth'; // Fixed import path
...
const LoginPage = () => {
  ...
  const handleGoogleSuccess = (user) => {
    ...
    // Navigation is handled in GoogleAuth component
  };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Google Login Button */}
          <GoogleAuth type="login" onSuccess={handleGoogleSuccess} buttonText="Login with Google" />
        </div>
      </div>
    </div>
  );
...
//               <Link
//                 to="/forgot-password"
//                 className="text-[#DB4444] hover:underline text-base"
//               >
//                 Forget Password?
//               </Link>
//             </div>
