...
const RegisterPage = () => {
  ...
  const handleGoogleSuccess = (user) => {
    ...
    // For Google sign up, also redirect to login page
    setTimeout(() => {
      navigate('/login');
    }, 1500);
  };
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4 pt-2">
              ...
              <GoogleAuth type="signup" onSuccess={handleGoogleSuccess} />
            </div>
            
            <p className="text-center text-gray-600 text-base">
              Already have account? <Link to="/login" className="font-medium hover:underline ml-3">Log in</Link>
            </p>
          </form>
        </div>
      </div>
