...
//     <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex justify-between items-center h-16 bg-black w-full">
//         <div className="container">
//           <div className="sale-banner text-white">
...
//             {/* Account */}
//             <Link to="/account" className="text-2xl">👤</Link>
//           </div>
...
//                 className="absolute top-full left-0 w-64 bg-white shadow-lg rounded-md py-2 z-50"
//               >
//                 {['Woman\'s Fashion', 'Men\'s Fashion', 'Electronics', 'Home & Lifestyle', 'Medicine', 'Sports & Outdoor', 'Baby\'s & Toys', 'Groceries & Pets', 'Health & Beauty'].map(category => (
//                   <Link
//                     key={category}
//                     to={`/products?category=${category}`}
//                     className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
